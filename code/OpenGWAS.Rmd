...
```{r}
# meta_all <- MungeSumstats::find_sumstats()
# opts <- toupper(eval(formals(MAGMA.Celltyping::get_genome_ref)$population))
    ...
    return(gene_files[[meta$id[i]]])
     ...
     tryCatch(expr = {
       MAGMA.Celltyping::map_snps_to_genes(
         ...
         N = meta$N[i],
         population = popdict[[meta$population[i]]],
         upstream_kb = 35,  
         downstream_kb = 10, 
         force_new = FALSE
         )
